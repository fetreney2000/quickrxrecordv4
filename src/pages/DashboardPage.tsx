...
const ALL_CARDS: StatCardConfig[] = [
  ...
  { key: "supply", title: "Bekalan Hari Ini", subtitle: "Pembekalan yang dilakukan hari ini", icon: TrendingUp, gradient: ["#7c3aed", "#8b5cf6"], roles: ["Pentadbir", "Penjaga Stor", "Kakitangan Farmasi", "Kakitangan Klinik"], getValue: (s) => s.supplyToday, href: "/pantas" },
  { key: "expiry", title: "Akan Luput (30 Hari)", subtitle: "Kelompok yang akan tamat tempoh", icon: AlertTriangle, gradient: ["#ea580c", "#f97316"], roles: ["Pentadbir", "Penjaga Stor", "Kakitangan Farmasi", "Kakitangan Klinik"], getValue: (s) => s.expiringSoon, href: "/stok" },
