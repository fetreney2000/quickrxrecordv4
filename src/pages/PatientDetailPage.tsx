...
export default function PatientDetailPage() {
  ...
  const supplyAgeMap = useMemo(() => {
    const map = new Map<string, string | null>();
    for (const a of assignments) {
      map.set(a.id, formatSupplyAge(latestSupplyDates?.get(a.id)));
    }
    return map;
