      ...
      <div>
        ...
        >
          <div className="pt-3 pb-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2">
            <div><Label style={labelStyle}>Dari</Label><DateInput value={filterDateFrom} onChange={(v) => { setFilterDateFrom(v); setTxPage(0); }} className="h-10 text-xs w-full" style={inputBaseStyle} /></div>
            <div><Label style={labelStyle}>Hingga</Label><DateInput value={filterDateTo} onChange={(v) => { setFilterDateTo(v); setTxPage(0); }} className="h-10 text-xs w-full" style={inputBaseStyle} /></div>
